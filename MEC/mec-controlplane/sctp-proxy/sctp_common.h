...
#else
#define SCTP_ERROR(x, args...)                  \
    do {                                        \
        fprintf(stderr, "[SCTP][E]" x, ##args); \
    } while (0)
#define SCTP_DEBUG(x, args...)                  \
    do {                                        \
        fprintf(stdout, "[SCTP][D]" x, ##args); \
    } while (0)
#define SCTP_WARN(x, args...)                   \
    do {                                        \
        fprintf(stdout, "[SCTP][W]" x, ##args); \
    } while (0)
#endif
