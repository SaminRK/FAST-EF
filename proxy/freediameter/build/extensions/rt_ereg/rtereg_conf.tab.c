...
#define yyparse         rtereg_confparse
#define yylex           rtereg_conflex
#define yyerror         rtereg_conferror
#define yydebug         rtereg_confdebug
#define yynerrs         rtereg_confnerrs


/* Copy the first part of user declarations.  */
#line 50 "/home/samin/workspace/research_implementation/proxy/freediameter/src/extensions/rt_ereg/rtereg_conf.y" /* yacc.c:339  */
...
#line 129 "/home/samin/workspace/research_implementation/proxy/freediameter/build/extensions/rt_ereg/rtereg_conf.tab.c" /* yacc.c:339  */
...
/* In a future release of Bison, this section will be replaced
   by #include "rtereg_conf.tab.h".  */
#ifndef YY_RTEREG_CONF_HOME_SAMIN_WORKSPACE_RESEARCH_IMPLEMENTATION_PROXY_FREEDIAMETER_BUILD_EXTENSIONS_RT_EREG_RTEREG_CONF_TAB_H_INCLUDED
# define YY_RTEREG_CONF_HOME_SAMIN_WORKSPACE_RESEARCH_IMPLEMENTATION_PROXY_FREEDIAMETER_BUILD_EXTENSIONS_RT_EREG_RTEREG_CONF_TAB_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 1
#endif
#if YYDEBUG
extern int rtereg_confdebug;
#endif
...
union YYSTYPE
{
#line 108 "/home/samin/workspace/research_implementation/proxy/freediameter/src/extensions/rt_ereg/rtereg_conf.y" /* yacc.c:355  */

	char 		*string;	/* The string is allocated by strdup in lex.*/
	int		integer;

#line 181 "/home/samin/workspace/research_implementation/proxy/freediameter/build/extensions/rt_ereg/rtereg_conf.tab.c" /* yacc.c:355  */
};
...
int rtereg_confparse (char * conffile);

#endif /* !YY_RTEREG_CONF_HOME_SAMIN_WORKSPACE_RESEARCH_IMPLEMENTATION_PROXY_FREEDIAMETER_BUILD_EXTENSIONS_RT_EREG_RTEREG_CONF_TAB_H_INCLUDED  */

/* Copy the second part of user declarations.  */

#line 211 "/home/samin/workspace/research_implementation/proxy/freediameter/build/extensions/rt_ereg/rtereg_conf.tab.c" /* yacc.c:358  */
...
{
  "$end", "error", "$undefined", "LEX_ERROR", "QSTRING", "INTEGER", "AVP",
  "'='", "';'", "':'", "'+'", "$accept", "conffile", "avp", "rules",
  "rule", YY_NULLPTR
};
#endif
...
{
       0,   256,   257,   258,   259,   260,   261,    61,    59,    58,
      43
};
# endif
...
{
       4,     3,     5,     8,     9,    13,    11,    12,     4,     0,
       0,    16,     0,    14,    15,    10,    17
};

static const yytype_int8 yycheck[] =
{
       4,     0,     6,     9,     7,    10,     4,     4,     4,    -1,
      -1,     5,    -1,     8,     7,     6,     8
};
...
yyreduce:
  ...
  switch (yyn)
    {
        case 3:
#line 133 "/home/samin/workspace/research_implementation/proxy/freediameter/src/extensions/rt_ereg/rtereg_conf.y" /* yacc.c:1646  */
    {
				...
				CHECK_FCT_DO( fd_dict_search ( fd_g_config->cnf_dict, DICT_AVP, AVP_BY_NAME, (yyvsp[-1].string), &rtereg_conf.avp, ENOENT ),
					{
						TRACE_DEBUG(INFO, "Unable to find '%s' AVP in the loaded dictionaries.", (yyvsp[-1].string));
				...
				/* Now check the type */
				{
					...
					CHECK_PARAMS_DO (data.avp_basetype == AVP_TYPE_OCTETSTRING, 
						{
							TRACE_DEBUG(INFO, "'%s' AVP in not an OCTETSTRING AVP (%d).", (yyvsp[-1].string), data.avp_basetype);
							yyerror (&yylloc, conffile, "AVP in not an OCTETSTRING type.");
							YYERROR;
						} );
				}
			}
#line 1411 "/home/samin/workspace/research_implementation/proxy/freediameter/build/extensions/rt_ereg/rtereg_conf.tab.c" /* yacc.c:1646  */
    break;

  case 6:
#line 165 "/home/samin/workspace/research_implementation/proxy/freediameter/src/extensions/rt_ereg/rtereg_conf.y" /* yacc.c:1646  */
    {
				...
				new->pattern = (yyvsp[-6].string);
				new->server  = (yyvsp[-4].string);
				new->score   = (yyvsp[-1].integer);
...
#line 1460 "/home/samin/workspace/research_implementation/proxy/freediameter/build/extensions/rt_ereg/rtereg_conf.tab.c" /* yacc.c:1646  */
    break;


#line 1464 "/home/samin/workspace/research_implementation/proxy/freediameter/build/extensions/rt_ereg/rtereg_conf.tab.c" /* yacc.c:1646  */
      default: break;
    }
