# Install script for directory: /home/samin/workspace/research_implementation/proxy/freediameter/src/extensions/rt_default
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xfreeDiameter-daemonx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib/freeDiameter" TYPE MODULE FILES "/home/samin/workspace/research_implementation/proxy/freediameter/build/extensions/rt_default.fdx")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/freeDiameter/rt_default.fdx" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/freeDiameter/rt_default.fdx")
