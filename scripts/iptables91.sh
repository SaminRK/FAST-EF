...
sudo iptables -t nat -I OUTPUT 6 -d 10.20.40.3 -p tcp --dport 8000 -j DNAT --to-destination ${EPC_HOST}:8011
sudo iptables -t nat -I OUTPUT 7 -d 10.20.50.3 -p tcp --dport 8000 -j DNAT --to-destination ${EPC_HOST}:8012